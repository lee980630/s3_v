...
# kernel path: /root/workspace/VRAG_test/VRAG_lsm/tmp/torchinductor_root/ar/carjmua5bb7mqdzfqeudxveywzgkahv5s5jslylnooe5bu7sgm72.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_bitwise_and_bitwise_not_bitwise_or_ge_lt_mul_sub_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': '47F64A9F6A85E0BCC1AF063FAD76D919A3624F50FDDB2C9704DA0603639DC738', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
...
def call(args):
    ...
    s5 = arg5_1
    s6 = arg6_1
    assert_size_stride(arg1_1, (s1, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((s1, ), (1, ), torch.int64)
        buf1 = empty_strided_cuda((s1, ), (1, ), torch.bool)
        # Topologically Sorted Source Nodes: [ge, lt, org_vocab_mask, ge_1, lt_1, added_vocab_mask, vocab_mask, mul, mul_1, valid_offset, sub_3, input_, invert], Original ATen: [aten.ge, aten.lt, aten.bitwise_and, aten.bitwise_or, aten.mul, aten.add, aten.sub, aten.bitwise_not]
        stream0 = get_raw_stream(0)
        triton_poi_fused_add_bitwise_and_bitwise_not_bitwise_or_ge_lt_mul_sub_0.run(arg1_1, buf0, buf1, s2, s3, s4, s5, s6, s1, grid=grid(s1), stream=stream0)
        del arg1_1
    return (buf0, buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 807
    arg1_1 = rand_strided((807, ), (1, ), device='cuda:0', dtype=torch.int32)
    arg2_1 = 76032
    arg3_1 = 152064
    arg4_1 = 152064
    arg5_1 = 152064
